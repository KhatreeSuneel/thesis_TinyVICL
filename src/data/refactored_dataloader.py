...
def load_data(CFG: Dict) -> None:
    ...
    loss_mapping = CFG["loss_functions"]
    ...
    df = _get_meta_data_with_labels(search_dir, supported_types,loss_mapping)
    recollect = False
...
def _get_meta_data_with_labels(search_dir: str,types: List[str],loss_mapping: Dict[str, str]) -> pd.DataFrame:
    """
    ...
    for task_dir in root.iterdir():
        ...
        lossfun = loss_mapping.get(task_name, "MSE")
